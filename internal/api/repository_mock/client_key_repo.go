...
// Source: github.com/hotstone-seo/hotstone-seo/internal/api/repository (interfaces: ClientKeyRepo)
...
func (m *MockClientKeyRepo) Insert(arg0 context.Context, arg1 repository.ClientKey) (repository.ClientKey, error) {
	m.ctrl.T.Helper()
