...
// Source: github.com/hotstone-seo/hotstone-seo/server/metric (interfaces: MetricsRuleMatchingService)
...
func (m *MockMetricsRuleMatchingService) Insert(arg0 context.Context, arg1 metric.MetricsRuleMatching) error {
	m.ctrl.T.Helper()
...
func (m *MockMetricsRuleMatchingService) ListCountHitPerDay(arg0 context.Context, arg1, arg2, arg3 string) ([]*metric.MetricsCountHitPerDay, error) {
	m.ctrl.T.Helper()
...
func (m *MockMetricsRuleMatchingService) ListMismatchedCount(arg0 context.Context, arg1 repository.PaginationParam) ([]*metric.MetricsMismatchedCount, error) {
	m.ctrl.T.Helper()
...
func (m *MockMetricsRuleMatchingService) SetMatched(arg0 *metric.MetricsRuleMatching, arg1 string, arg2 int64) {
	m.ctrl.T.Helper()
...
func (m *MockMetricsRuleMatchingService) SetMismatched(arg0 *metric.MetricsRuleMatching, arg1 string) {
	m.ctrl.T.Helper()
