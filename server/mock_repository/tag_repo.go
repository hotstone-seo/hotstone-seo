...
// Source: github.com/hotstone-seo/hotstone-seo/server/repository (interfaces: TagRepo)
...
func (m *MockTagRepo) Find(arg0 context.Context, arg1 repository.TagFilter) ([]*repository.Tag, error) {
	m.ctrl.T.Helper()
