describe('Tags', () => {
  ...
  context('Add', () => {
    ...
    it('new Script Tag', () => {
      ...
      cy.get('[data-testid="select-type"]').type('Script{enter}');
      cy.get('[data-testid="select-locale"]').type('id_ID{enter}');
      cy.get('[data-testid="input-src"]').type('https://foo.com/test.js');

      cy.get('[data-testid="text-preview-tag"]').should('have.text', '<script src="https://foo.com/test.js"></script>');
