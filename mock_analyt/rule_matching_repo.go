...
// Source: github.com/hotstone-seo/hotstone-seo/analyt (interfaces: RuleMatchingRepo)
...
func (m *MockRuleMatchingRepo) Insert(arg0 context.Context, arg1 analyt.RuleMatching) error {
	m.ctrl.T.Helper()
