...
func init() {
	typapp.Provide(
		...
		typapp.NewConstructor("", repository.NewClientKeyRepo),
		typapp.NewConstructor("", repository.NewDataSourceRepo),
		typapp.NewConstructor("", repository.NewHistoryRepo),
		typapp.NewConstructor("", repository.NewRoleTypeRepo),
		...
		typapp.NewConstructor("", service.NewClientKeyService),
		...
		typapp.NewConstructor("", service.NewRoleTypeService),
