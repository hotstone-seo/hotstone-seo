...
// Source: app/urlstore/urlstore_sync_service.go
...
func (m *MockURLStoreSyncService) FindOne(ctx context.Context, id int64) (*urlstore.URLStoreSync, error) {
	m.ctrl.T.Helper()
...
func (m *MockURLStoreSyncService) Find(ctx context.Context) ([]*urlstore.URLStoreSync, error) {
	m.ctrl.T.Helper()
...
func (m *MockURLStoreSyncService) Insert(ctx context.Context, URLStoreSync urlstore.URLStoreSync) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockURLStoreSyncService) GetListDiff(ctx context.Context, offsetVersion int64) ([]*urlstore.URLStoreSync, error) {
	m.ctrl.T.Helper()
