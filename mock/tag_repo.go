...
func (m *MockTagRepo) Find(arg0 context.Context, arg1 int64) (*repository.Tag, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTagRepoMockRecorder) Find(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Find", reflect.TypeOf((*MockTagRepo)(nil).Find), arg0, arg1)
}

// List mocks base method
func (m *MockTagRepo) List(arg0 context.Context) ([]*repository.Tag, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTagRepoMockRecorder) List(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
