...
func (m *MockDataSourceRepo) Find(arg0 context.Context, arg1 int64) (*repository.DataSource, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataSourceRepo) List(arg0 context.Context) ([]*repository.DataSource, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDataSourceRepoMockRecorder) List(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockDataSourceRepo)(nil).List), arg0)
}
