...
func (m *MockURLStoreServer) Start() error {
	m.ctrl.T.Helper()
...
func (mr *MockURLStoreServerMockRecorder) Start() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockURLStoreServer)(nil).Start))
}
